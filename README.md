...
# book_list.txt 작성법 (Markdown 예시 포함)

## book_list.txt 파일은 오픈소스 도서 목록을 체계적으로 정리하고, 각 도서의 제목, 저자, 간단한 소개를 담는 문서입니다. 아래는 효과적으로 작성하는 방법과 마크다운 문법 예시입니다.

**1. 기본 구조**
제목: 파일 맨 위에 대제목을 작성합니다.
예) # 오픈소스 도서 목록

도서 목록: 번호 있는 리스트(1., 2. 등)로 각 도서를 구분합니다.

도서 정보: 각 항목에 도서명, 저자, 간단한 소개를 2~4줄로 작성합니다.

강조: 도서명은 굵게, 저자는 기울임 등으로 표현하면 가독성이 좋아집니다.

**2. 마크다운 문법 활용**
제목(Headers): #, ## 등 해시 기호로 제목을 구분합니다.
...
링크(선택): [도서명](URL) 형식으로 외부 링크를 추가할 수 있습니다.


#팀 정보

팀장 : 이인 (2021125050 / 소프트웨어학과)
